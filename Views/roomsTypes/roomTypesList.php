        ...
        <table class="data-table">
            ...
            <?php if(
                ...
                <?php foreach($roomTypes as $type) { ?>
                    ...
                    <?php
                    // Convert amenities JSON to array if not already done
                    ...
                    <tr>
                        ...
                        <td class="image-cell">
                            ...
                            <?php if(
                                ...
                                <img
                                    src="/HotelBookingSystemMerged/<?php
                        ...
                        <td class="actions-cell">
                            ...
                            <a
                                href="/HotelBookingSystemMerged/Controller/roomTypeController.php?action=edit&id=<?php echo $type['id']; ?>"
            ...
            <?php } else { ?>
                ...
                <tr>
                    ...
                    <td colspan="7" style="text-align:center;">
                        ...
                        <a href="/HotelBookingSystemMerged/Controller/roomTypeController.php?action=create">
                            Add one
                        </a>
                    </td>

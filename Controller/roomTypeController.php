            ...
            else
            {
                ...
                if(move_uploaded_file($tmp, $dir . $filename))
                {
                    if(!empty($data['thumbnail_path']) && 
                       file_exists($_SERVER['DOCUMENT_ROOT'] . '/HotelBookingSystemMerged/' . $data['thumbnail_path']))
                    {
                        unlink($_SERVER['DOCUMENT_ROOT'] . '/HotelBookingSystemMerged/' . $data['thumbnail_path']);
                    }
